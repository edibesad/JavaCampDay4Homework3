...
public class FBTKPSPublicSoap
{
    ...
    public FBTKPSPublicSoap(){}

    public FBTKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public FBTKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        FBTExtendedSoapSerializationEnvelope envelope= new FBTExtendedSoapSerializationEnvelope(FBTExtendedSoapSerializationEnvelope.VER11);
