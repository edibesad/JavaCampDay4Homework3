...
public class FBTExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(FBTDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new FBTStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static FBTDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static FBTDateTimeConverter dateTimeConverter = new FBTStandardDateTimeConverter();

    public FBTExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public FBTExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new FBTMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=FBTHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,FBTExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=FBTHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
